...
export default function Stats() {
  return (
    <section className="py-16 bg-gradient-to-r from-cyan-500 to-green-500">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold font-heading text-white mb-4">Notre Impact en Chiffres</h2>
          <p className="text-xl text-white/90 max-w-3xl mx-auto">
            Les réalisations de l'AMED pour l'environnement et la digitalisation
          </p>
        </div>
